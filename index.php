...
<head>
  <meta charset="UTF-8">
  <title>PPR 2019 Slideshow Media Submission</title>
    ...
    margin: 0 auto !important;"class="">
      ...
      <div class="input-group mb-3">
        ...
        <select name="posse" class="custom-select" id="inputGroupSelect01">
          ...
          <option value="LA15">LA' 16 </option>
...
<option value="CHI15">CHI' 16 </option>
